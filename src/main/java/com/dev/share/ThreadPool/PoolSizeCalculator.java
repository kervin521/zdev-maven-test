...
public abstract class PoolSizeCalculator {
     ...
     * defualt cpu time
     */
    public final long DEFAULT_CURRENT_THREAD_CPU_TIME = ManagementFactory.getThreadMXBean().getCurrentThreadCpuTime();
    ...
    private void calculateOptimalCapacity(BigDecimal targetQueueSizeBytes) {
        ...
        System.out.println(
            "createTask() produced " + creatTask().getClass().getName() + " which took " + mem + " bytes in a queue");
