 ...
 * SingleShotTime: 在每次执行中计算耗时,以上模式都是默认一次 iteration 是 1s，只有 SingleShotTime
 * 是只运行一次。
 */
...
public class BenchmarkJmhTest {
	...
	public static void main(String[] args) throws RunnerException {
		Options options = new OptionsBuilder().include(BenchmarkJmhTest.class.getSimpleName())// 代表我要测试的是哪个类的方法
